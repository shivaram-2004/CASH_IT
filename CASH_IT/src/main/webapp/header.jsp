...
<script src='https://kit.fontawesome.com/a076d05399.js'></script>
    ...
    <%String email=session.getAttribute("email").toString();%>
            ...
            <h2><a href=""><%out.println(email); %> <i class="fa fa-user" aria-hidden="true"></i></a></h2>
            <a href="home.jsp">Home<i class="fa fa-institution"></i></a>
            <a href="myCart.jsp">My Cart<i class="fa fa-cart-plus" aria-hidden="true"></i></a>
            <a href="myOrders.jsp">My Orders  <i class='fab fa-elementor'></i></a>
            <a href="changeDetails.jsp">Change Details <i class="fa fa-edit"></i></a>
            <a href="messageUs.jsp">Message Us <i class="fa fa-comment" aria-hidden="true"></i></a>
