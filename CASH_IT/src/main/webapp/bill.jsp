...
<h3>Product Details</h3>
  ...
  <%
  ResultSet rs1=st.executeQuery("select * from cart inner join amount where cart.id=amount.id and cart.email='"+email+"' and cart.status='bill'");
  while(rs1.next())
  {
	  sno=sno+1;
...
<a href="continueShopping.jsp"><button class="button left-button">Back to add</button></a>
